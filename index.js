...
// ANSWER: O(n) linear because numbers.length has a growing rate

// Q: Given an array of numbers, what is the space complexity of this function?
// ANSWER: O(1) constant because the variable are not changing and there are no variable set inside the function. 
...
// ANSWER: O(1) constant because there is no growing rate (i.e. numbers.length)

// Q: What is the space complexity of this function?
// ANSWER: O(1) constant because there is only one variable set and you're not redeclaring anything and it doesn't have a growing rate.
...
// Q: What is the time complexity of this function?
// ANSWER: O(n) linear because number could be set to a variable and have a growing rate

// Q: What is the space complexity of this function?
// ANSWER: O(1) constant because there is only one variable set in the for loop
...
// Q: What is the time complexity of this function?
// ANSWER: O(n) linear because both num and arr will have growing rates

// Q: What is the space complexity of this function?
// ANSWER: O(1) constant because there are only two variables set 
...
// Q: What is the time complexity of this function?
// ANSWER: O(n^2) quadratic because each time the inner loop iterates it will multiply by each of the outer loop. 

// Q: What is the space complexity of this function?
// ANSWER: O(1) constant because there is only two variables set
...
// ANSWER: O(n) linear because as numbers array has things added, the filters is another 'loop' which will have a growing rate

// Q: What is the space complexity of the filter higher-order function?
// ANSWER: O(n) linear because filter is set to a new variable
...
// ANSWER: O(n) linear because map is also like a 'loop' and it can have a growing rate 

// Q: What is the space complexity of the map higher-order function?
// ANSWER: O(n) linear because there is a new variable set 
...
// ANSWER: O(n) because .splice() is kinda of a loop
...
// Q: What is the time complexity of the function?
// ANSWER: O(1) constant because it adds at the end and it won't add time so it will stay the same
...
// Q: What is the time complexity of the function? 
// ANSWER: O(1) constant because it's just console logging the index of the array, it isn't looping through anything
...
function arrInception(parentArr) {
  ...
  // Q: What is the space complexity of this function?
  // ANSWER: O(1) constant because the child array stays the same 
...
// Q: What is the space complexity of this function?
// ANSWER: O(n) linear because it is setting a new variable inside the for loop 
...
// ANSWER: These are the same space complexity O(n) linear because memory grows at a linear rate as the input length grows 
...
// ANSWER: because memory grows at a linear rate as the input length grows 
